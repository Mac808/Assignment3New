...
<html>
<head>
<title> Pure Protein Bar - Chocolate Deluxe </title>
      ...
      <th height="480" bgcolor="#FFFFFF" scope="col"><table width='98%' height="98%" border='0' align='center' bgcolor='cccccc'>
        <tr>
          <td width='41%' height="465"><table width="100%" height="274" >
            <tr>
              <th bgcolor="#FFFFFF" scope="col"><table width="100%" height="95%" >
                <tr>
                  <th bgcolor="#CCCCCC" scope="col"><img src='./CD.png' width="150" height="150"></th>
                </tr>
              </table></th>
            </tr>
          </table>
		  <a href="./barpeanut.php"><--Previous Product</a> &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
          ...
          <td width="59%" align='top left' valign="top"><h2><font face="Verdana, Arial, Helvetica, sans-serif"> <font color="#993300"><br>
            Pure Protein Bars - Chocolate Deluxe </font></font></h2>
              <br>
			  <Br>
			  <p align="left"><font color="#993300" face="Arial, Helvetica, sans-serif">Description:<br>
  One Dozen (12) </font><font color="#993300" face="Arial, Helvetica, sans-serif" style='text'> Pure Protein Bars - Chocolate Deluxe </font></p>
...
if (isset($_POST['addcart'])) {
	...
	elseif($quantity==0){
		...
		if ($_SESSION['sponge_box_quantity'] > 0) {
			$_SESSION['sponge_box_quantity']+= $quantity;
		}
		else {
			$_SESSION['sponge_box_quantity']=$quantity;
		}
