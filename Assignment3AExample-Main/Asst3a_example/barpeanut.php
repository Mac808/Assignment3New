...
<html>
<head>
<title> Pure Protein Bar - Chocolate Peanut Butter </title>
          ...
          <td width='41%' height="465"><table width="100%" height="274" >
            <tr>
              <th bgcolor="#FFFFFF" scope="col"><table width="100%" height="95%" >
                <tr>
                  <th bgcolor="#CCCCCC" scope="col"><img src='./CPB.png' width="150" height="150"></th>
                </tr>
              </table></th>
            </tr>
          </table>
		  <a href="./barchocolate.php"><--Previous Product</a> &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
		  &nbsp; &nbsp; &nbsp;<a href="./Creatine.php">Next Product--> </a>
		  </td>
          <td width="59%" align='top left' valign="top"><h2><font face="Verdana, Arial, Helvetica, sans-serif"> <font color="#993300"><br>
            Pure Protein Bar - Chocolate Peanut Butter </font></font></h2>
              <br>
			  <Br>
			  <p align="left"><font color="#993300" face="Arial, Helvetica, sans-serif">Description:<br>
  One Dozen (12) </font><font color="#993300" face="Arial, Helvetica, sans-serif" style='text'> Pure Protein Bar <br>
  </font><font color="#993300" face="Arial, Helvetica, sans-serif"> Chocolate Peanut Butter </font><font color="#993300">.</font></p>
              <p align="left"><font color="#CC3300">Price: $59.99</font></p>
...
if (isset($_POST['addcart'])) {
	...
	elseif($quantity==0){
		...
		if ($_SESSION['sponge_quantity'] > 0) {
			$_SESSION['sponge_quantity']+= $quantity;
		}
		else {
			$_SESSION['sponge_quantity']=$quantity;
		}
