...
<html>
<head>
<title> Optimum Nutrition Creatine </title>
  ...
  <table width="60%" height="587" >
    <tr>
      <th height="38" align="left" valign="bottom" bgcolor="#FFFFFF" scope="col"><div align="center">
        <h1><font color="#993300" face="Verdana, Arial, Helvetica, sans-serif">Grandma's Own Cookie Store</font></h1>
      </div></th>
    </tr>
    <tr>
          ...
          <td width='41%' height="465"><table width="100%" height="274" >
            <tr>
              <th bgcolor="#FFFFFF" scope="col"><table width="100%" height="95%" >
                <tr>
                    <th bgcolor="#CCCCCC" scope="col"><img src='./Creatine.jpg' width="150" height="150"></th>
                </tr>
              </table></th>
            </tr>
          </table>
		  <a href="./barchocolate.php"><--Previous Product</a> &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
		  &nbsp; &nbsp; &nbsp;<a href="./barpeanut.php">Next Product--> </a>
		  </td>
          <td width="59%" align='top left' valign="top"><h2><font face="Verdana, Arial, Helvetica, sans-serif"> <font color="#993300"><br>
            Optimum Nutrition Creatine </font></font></h2>
              <br>
			  <Br>
			  <p align="left"><font color="#993300" face="Arial, Helvetica, sans-serif">Description:<br>
			  </font><font color="#993300" face="Arial, Helvetica, sans-serif" style='text'> Optimum Nutrition Creatine <br></font></p>
              <p align="left"><font color="#CC3300">Price: $44.99</font></p>
...
if (isset($_POST['addcart'])) {
	...
	elseif($quantity==0){
		...
		if ($_SESSION['sponge_cake_quantity'] > 0) {
			$_SESSION['sponge_cake_quantity']+= $quantity;
		}
		else {
			$_SESSION['sponge_cake_quantity']=$quantity;
		}
