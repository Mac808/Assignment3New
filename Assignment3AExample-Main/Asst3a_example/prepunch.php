          ...
          <td width='41%' height="465"><table width="100%" height="274" >
            <tr>
              <th bgcolor="#FFFFFF" scope="col"><table width="100%" height="95%" >
                <tr>
                  <th bgcolor="#CCCCCC" scope="col"><img src='./FP.jpg' width="150" height="150"></th>
                </tr>
              </table></th>
            </tr>
          </table>
		  <a href="./prerazz.php"><--Previous Product</a> &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
		  &nbsp; &nbsp; &nbsp;<a href="./prelemonade.php">Next Product--> </a>
		  </td>
          <td width="59%" align='top left' valign="top"><h2><font face="Verdana, Arial, Helvetica, sans-serif"> <font color="#993300"><br>
            Pre-Workout - Fruit Punch </font></font></h2>
             <br>
			 <br>
			  <p align="left"><font color="#993300" face="Arial, Helvetica, sans-serif">Description:<br>
                              30 Servings <br></font><font color="#993300" face="Arial, Helvetica, sans-serif" style='text'> C4 Pre-Workout <br>
  </font><font color="#993300" face="Arial, Helvetica, sans-serif"> Fruit Punch Flavored </font><font color="#993300">.</font></p>
              <p align="left"><font color="#CC3300">Price: $26.48</font></p>
...
if (isset($_POST['addcart'])) {
	...
	elseif($quantity==0){
		...
		if ($_SESSION['peanut_candy_quantity'] > 0) {
			$_SESSION['peanut_candy_quantity']+= $quantity;
		}
		else {
			$_SESSION['peanut_candy_quantity']=$quantity;
		}
