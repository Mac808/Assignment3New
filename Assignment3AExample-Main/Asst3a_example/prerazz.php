...
<div align="center">
          ...
          <td width='41%' height="465"><table width="100%" height="274" >
            <tr>
              <th bgcolor="#FFFFFF" scope="col"><table width="100%" height="95%" >
                <tr>
                  <th bgcolor="#CCCCCC" scope="col"><img src='./IBR.jpg' width="150" height="150"></th>
                </tr>
              </table></th>
            </tr>
          </table>
		  <a href="./prelemonade.php"><--Previous Product</a> &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
		  &nbsp; &nbsp; &nbsp;<a href="./prepunch.php">Next Product--> </a>
		  </td>
          <td width="59%" align='top left' valign="top"><h2><font face="Verdana, Arial, Helvetica, sans-serif"> <font color="#993300"><br>
            Pre-Workout - Icy Blue Razz </font></font></h2>
             <br>
			 <br>
  ...
  </font><font color="#993300" face="Arial, Helvetica, sans-serif"> Icy Blue Razz Flavored </font><font color="#993300">.</font></p>
              <p align="left"><font color="#CC3300">Price: $39.99</font></p>
...
if (isset($_POST['addcart'])) {
	...
	elseif($quantity==0){
		...
		if ($_SESSION['peanut_quantity'] > 0) {
			$_SESSION['peanut_quantity']+= $quantity;
		}
		else {
			$_SESSION['peanut_quantity']=$quantity;
		}
