...
//defining a function to show the product
...
<html>
<head>
<title>Gold Standard Whey Protein - Mocha Cappuccino</title>
          ...
          <td width='41%' height="465"><table width="100%" height="274" >
            <tr>
              <th bgcolor="#FFFFFF" scope="col"><table width="100%" height="95%" >
                <tr>
                  <th bgcolor="#CCCCCC" scope="col"><img src='./MC.jpg' width="150" height="150"></th>
                </tr>
              </table></th>
            </tr>
          </table>
		  <a href="./wheychocolate.php"><--Previous Product</a> &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
		  &nbsp; &nbsp; &nbsp;<a href="./wheyvanilla.php">Next Product--> </a>
		  </td>
          <td width="59%" align='top left' valign="top"><h2><font face="Verdana, Arial, Helvetica, sans-serif"> <font color="#993300">
            <br> Whey Protein - Mocha Cappuccino </font></font></h2><Br>
			  <Br><p align="left"><font color="#993300" face="Arial, Helvetica, sans-serif">Description:<br>
  One dozen </font><font color="#993300" face="Arial, Helvetica, sans-serif" style='text'> Gold Standard Whey Protein <br>
  </font><font color="#993300" face="Arial, Helvetica, sans-serif"> Mocha Cappuccino Flavored </font><font color="#993300">.</font></p>
              <p align="left"><font color="#CC3300">Price: $19.99</font></p>
...
if (isset($_POST['addcart'])) {
	...
	if (!(is_numeric($quantity) && is_int($quantity - (int) $quantity) && $quantity >= 0)){
		...
		if ($_SESSION['choco_big_quantity'] > 0) {
			$_SESSION['choco_big_quantity']+= $quantity;
		}
		else {
			$_SESSION['choco_big_quantity']=$quantity;
		}
